...
- [ready](commands/ready.md)

## Snoozing

- [snooze](commands/snooze.md)
- [snooze-review](commands/snooze-review.md)
- [snooze-extend](commands/snooze-extend.md)
- [snooze-expire](commands/snooze-expire.md)

## Reports & Analytics

- [report](commands/report.md)
- [review-time](commands/review-time.md)
- [review-velocity](commands/review-velocity.md)
